...
class CashOutEntryDialog extends StatefulWidget {
  @override
  _CashOutEntryDialogState createState() => _CashOutEntryDialogState();
}

class _CashOutEntryDialogState extends State<CashOutEntryDialog> {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                        'Cash OUT saved in mock mode (${entries.length} record${entries.length == 1 ? '' : 's'}).'),
