...
class ProductTransferDialog extends StatelessWidget {
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildLabelledTextField(
                                  "Transfer No", Colors.yellow[100]),
                              const SizedBox(height: 8),
                              _buildDateField("Transfer Date"),
                            ],
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildDropdownField("Transfer From", "AUH"),
                              const SizedBox(height: 8),
                              _buildDropdownField("Transfer To", ""),
                            ],
                          ),
                        ),
                        const SizedBox(width: 8),
