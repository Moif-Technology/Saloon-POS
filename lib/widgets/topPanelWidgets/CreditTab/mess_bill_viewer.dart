...
class MessBillViewer extends StatelessWidget {
  static const Color _primaryColor = Color(0xFF521C1D);

  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final double dialogWidth = screenWidth > 900 ? 850 : screenWidth * 0.95;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildHeaderCell('Mess Bill Date', flex: 2),
          _buildHeaderCell('Customer Code', flex: 2),
          _buildHeaderCell('Customer Name', flex: 2),
          _buildHeaderCell('Multi Mess Item Name', flex: 2),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildTableCell('Dummy', flex: 2),
          _buildTableCell('C$index', flex: 2),
          _buildTableCell('Dummy $index', flex: 2),
          _buildTableCell('Dummy', flex: 2),
        ],
      ),
    );
