...
class DiscountSettingsDialog extends StatelessWidget {
  ...
  // ── 2. Configuration & Filter Section ────────────────────────────────────
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                _buildDateRangeField('Discount Date From:', '15/11/2024'),
                const SizedBox(height: 10),
                _buildDateRangeField('Discount Date To:', '15/11/2024'),
                const SizedBox(height: 10),
  ...
  Widget _buildDateRangeField(String label, String date) {
    return Row(
      children: [
        Expanded(
          child: Text(
